...
import PlanContainer from "./plans";
...
class BuyPlan extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      passedSteps: [1],
      plans: [
        {"id":"d1ba8db9-4b6e-49e7-878d-98d4c79e4b09","created":"2024-11-20T13:03:01.102494+03:00","modified":"2024-11-20T13:03:01.102494+03:00","created_by":"","modified_by":null,"plan":"10 Mbps unlimited","has_automatic_renewal":false,"price":"10.00","pricing":"one hour","plan_description":"5 Mbps unlimited","currency":"KSH","requires_payment":true,"requires_invoice":false},{"id":"0ef2b0b1-f544-458e-a79b-161710e8fb1e","created":"2024-11-20T13:03:01.312301+03:00","modified":"2024-11-20T13:03:01.312301+03:00","created_by":"","modified_by":null,"plan":"10 Mbps unlimited","has_automatic_renewal":false,"price":"1000.00","pricing":"1 month","plan_description":"5 Mbps unlimited","currency":"KSH","requires_payment":true,"requires_invoice":false},{"id":"9437ac6e-6d73-4e56-8b99-c76119c79df0","created":"2024-11-20T13:03:01.406544+03:00","modified":"2024-11-20T13:03:01.406544+03:00","created_by":"","modified_by":null,"plan":"10 Mbps unlimited","has_automatic_renewal":false,"price":"500.00","pricing":"2 Weeks","plan_description":"5 Mbps unlimited","currency":"KSH","requires_payment":true,"requires_invoice":false},{"id":"2091796d-83de-4a4d-b38b-0b1ca0ef78f4","created":"2024-11-20T13:03:01.487253+03:00","modified":"2024-11-20T13:03:01.487253+03:00","created_by":"","modified_by":null,"plan":"10 Mbps unlimited","has_automatic_renewal":false,"price":"150.00","pricing":"3 days","plan_description":"5 Mbps unlimited","currency":"KSH","requires_payment":true,"requires_invoice":false},{"id":"0d9a66db-9590-4b7a-859f-39546e86fb3c","created":"2024-11-20T13:03:01.569757+03:00","modified":"2024-11-20T13:03:01.569757+03:00","created_by":"","modified_by":null,"plan":"10 Mbps unlimited","has_automatic_renewal":false,"price":"30.00","pricing":"6 Hours","plan_description":"5 Mbps unlimited","currency":"KSH","requires_payment":true,"requires_invoice":false},{"id":"d69bc330-0b1b-43be-b1fe-b4bf0b0972da","created":"2024-11-20T13:03:01.652509+03:00","modified":"2024-11-20T13:03:01.652509+03:00","created_by":"","modified_by":null,"plan":"10 Mbps unlimited","has_automatic_renewal":false,"price":"300.00","pricing":"1 week","plan_description":"5 Mbps unlimited","currency":"KSH","requires_payment":true,"requires_invoice":false},{"id":"fd15024d-1605-491d-ae1b-764c7f6cf819","created":"2024-11-20T13:03:01.731769+03:00","modified":"2024-11-20T13:03:01.731769+03:00","created_by":"","modified_by":null,"plan":"10 Mbps unlimited","has_automatic_renewal":false,"price":"50.00","pricing":"24 hours","plan_description":"5 Mbps unlimited","currency":"KSH","requires_payment":true,"requires_invoice":false}
      ],
      plansFetched: false,
      // plansFetched: true,
      selectedPlan: {},
          ...
          {plans.map((plan, index) => {
            ...
            return (
              <div
                ...
                onClick={() => this.changePlan({ target: { value: currentIndex } })}
              >
  ...
  GetForm = () => {
    ...
    const { additional_info_text, input_fields, links } = mobile_money_payment_form;
    const { success, errors, selectedPlan, plans } = this.state;
    ...
    const handlePlanSelection = (plan) => {
      ...
      setShowBillingForm(true); // Open dialog when a plan is selected
    };
    ...
    return (
      <>
        ...
        {/* Dialog for BillingForm */}
        <Dialog open={showBillingForm} onClose={toggleBillingForm} fullWidth maxWidth="sm">
          <DialogContent>
            <BillingForm
              data={this.props}
              state={this.state}
