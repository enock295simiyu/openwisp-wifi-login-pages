        ...
        <div className="inner" style={{
          ...
          <form 
            ...
            style={{
              ...
              backdropFilter: "blur(1px)", // Blur effect for supported browsers
              WebkitBackdropFilter: "blur(1px)", // Safari-specific blur effect
          ...
          <div className="inner">
                ...
                <div className="row fieldset payment_id">
                  <div className="row">
                    ...
                    <label htmlFor="payment_id">M-Pesa Code</label>
